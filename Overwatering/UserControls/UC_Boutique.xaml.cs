...
namespace Overwatering
{
    public partial class UC_Boutique : UserControl
    {
        ...
        // Achat Marguerite
        private void BtnBuyDaisy_Click(object sender, RoutedEventArgs e)
        {
            if (Application.Current.MainWindow is MainWindow mw)
            {
        ...
        // Achat Rose
        private void BtnBuyRose_Click(object sender, RoutedEventArgs e)
        {
            if (Application.Current.MainWindow is MainWindow mw)
            {
        ...
        // Achat Tournesol
        private void BtnBuySun_Click(object sender, RoutedEventArgs e)
        {
            if (Application.Current.MainWindow is MainWindow mw)
            {
        ...
        private void BtnRetour_Click(object sender, RoutedEventArgs e)
        {
            if (Application.Current.MainWindow is MainWindow mw)
            {
                // On relance simplement le jeu. 
                // Grâce à tes variables 'static' dans UC_Jeu, les plantes seront toujours là !
                mw.LancerJeu();
            }
        }
    }
